...
@DisplayName("Batch Enabled Insert Benchmark")
public class BatchEnabledInsertBenchmark extends BaseBenchmark {

    /**
     * Logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(BatchEnabledInsertBenchmark.class);
    ...
    protected String getPersistenceUnitName(){
        return "BatchEnabledPersistenceUnit";
    }
