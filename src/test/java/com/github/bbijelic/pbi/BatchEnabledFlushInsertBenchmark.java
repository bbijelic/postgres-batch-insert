...
public class BatchEnabledFlushInsertBenchmark extends BaseBenchmark {

    /**
     * Logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(BatchEnabledFlushInsertBenchmark.class);
